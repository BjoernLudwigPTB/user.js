...
// PREF: Make sure that third-party cookies (if enabled) persist beyond the session.
...
// PREF: Clear everything but "Site Preferences" and "Cookies" in "Clear Recent History"
...
// PREF: Explicitly enable in-content SVG rendering (Firefox >= 53)
